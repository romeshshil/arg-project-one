<head>
    <meta charset="UTF-8">
    <title> Landing Website - @yield('htmlheader_title', 'Your title here') </title>
    ...
    <!-- backendLTE Skins. We have chosen the skin-blue for this starter
          page. However, you can choose any other skin. Make sure you
          apply the skin class to the body tag so the changes take effect.
    -->
    <link href="{{ asset('/backend/css/skins/skin-blue.css') }}" rel="stylesheet" type="text/css" />
    <!-- iCheck -->
